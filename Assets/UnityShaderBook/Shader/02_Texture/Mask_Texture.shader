Shader "UnityShaderBook/Mask_Texture"{
    Properties {
        ...
        // 高光程度
        _SpecularScale("Specular Scale", Range(-1.0, 1.0)) = 0
        // 高光颜色
    ...
    SubShader {
        Pass {
            ...
            fixed4 frag(v2f i) : SV_Target {
                ...
                // 计算高光项
                fixed specular = _LightColor0.rgb * _Specular.rgb * pow(saturate(dot(halfDir, tangentNormal)), _Gloss) * specularMask * _SpecularScale;
                // 混合
